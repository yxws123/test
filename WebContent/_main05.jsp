...
<div class="row">
  <div class="column" id="left_side">
    ...
    <div id="logonInfo"><%= myAccount.getUserId() %><br />
      ...
      <a href="javascript: void(0)">My Account</a> | <a href="<%= contextPath %>/core/user/logout.do">Logout</a></div>
    <div id="side_menu">
<script language="javascript">
  if (document.getElementById) {
	  ...
	  webFXTreeConfig.setDefaultTarget('main');	 
        ...
        var a23 = new WebFXTreeItem('Correction Notice', 'net.kline.actions.BLMasterAction.do?actn=find&Prefix=&BNo=&OceanVesselCode=&OceanVoyage=&Status=4&after=2005-1-1');
        a2.add( a23 );
...
//        document.write(a2);
        ...
        var a31 = new WebFXTreeItem('User', '<%= contextPath %>/core/user/userAdmin.do' );
        a3.add( a31 );

        var a32 = new WebFXTreeItem('Agent', '<%= contextPath %>/core/agent/agentAdmin.do' );
        a3.add( a32 );
...
*/            
  ...
  <div class="column" id="right_side">
    <iframe id="main" name="main" src="<%= contextPath %>/blank.html" width="100%" height="100%" frameborder="0"></iframe>
  </div>
</div>
</body>
</html>

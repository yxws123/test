<%@ page language="java"
	import="java.util.*,com.kline.*,com.kline.blconfirm.entity.BlMaster"
...
<script type='text/javascript' src='<%=contextPath%>/js/blconfirm.js'></script>
<script type="text/javascript">$(function() {
		...
		$("#btnSearch").bind("click", function() {
			...
			doSearch('<%=contextPath%>/blconfirm/blAdmin/findPage.do',
									sData);
						});
...
<body>
	<div id="listArea">
		...
		<div id="title" class="breadcrumb">BL List</div>
		<div id="actionbar" class="actionbar">
			<div class="row" style="margin-left: 0.5em;">
				<form id="frmSearch" name="frmSearch">
					<input type="text" name="blMasterId" value="ID"
						style="color: #CCCCCC; width: 90px;"
						onfocus="doFocus(this, 'ID')"
						onblur="doBlur(this, 'ID')" /> <input type="text"
					...
					<select name="officeCode">
						...
						<option value="1">BlMasterId</option>
						<option value="2">BlMasterName</option>
					</select><input id="btnSearch" name="btnSearch" type="button" value="Search" />
				</form>
			</div>
			<div class="row" style="padding-left: 3px;">
				<input id="btnNewBlMaster" name="btnNewBlMaster" type="button"
					value="New BlMaster" onclick="doNewBlMaster()" /> <input
					id="btnDeleteBlMaster" name="btnDeleteBlMaster" type="button"
					value="Delete BlMaster" onclick="doDeleteBlMaster()" />
			</div>
		</div>
		<div id="content" style="display: "></div>
	</div>
	<div id="viewArea" style="display: ">
		<a name="blView_start" id="blView_start"></a>
		<div id="viewBL">
			<div id="title" class="breadcrumb">
				<a href="javascript: void(0);" onclick="gotoList()">BL List</a>
				>> BL: <span id="id"></span>
			</div>
			<div id="content"></div>
		</div>
		<div id="editBL" style="display: none;">
			<div id="title" class="breadcrumb">
				<a href="javascript: void(0);" onclick="gotoList()">BL List</a>
				>> BL: <a href="javascript: void(0);" onclick="doCancel()"><span

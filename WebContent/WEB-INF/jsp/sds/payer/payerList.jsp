...
<table id="payerList" width="100%">
	...
	<tbody>
		...
		<tr id="<%=StringUtils.trim(payer.getPayerCode())%>"
			...
			onmouseout="doChangeClass(this, '')" onclick="doSelectPayer(this)">
			...
			<td id="payerName" title="<%=StringUtils.toBriefString(payer.getPayerName(), 0)%>"><%=StringUtils.toBriefString(payer.getPayerName(), 30)%></td>
